...
Файл **data/municipalities.xlsx** содержит данные статьи «**Миграционный ландшафт России: типология муниципальных образований и закономерности пространственной мобильности населения**»*(находится на рецензировании)*.
